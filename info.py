...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002620790912')  # Support group id (make sure bot is admin)
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '-1002620790912')  # Support group link (make sure bot is admin)
