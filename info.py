...
PICS = (environ.get('PICS', 'https://i.ibb.co/PG9BXWzX/file-293.jpg https://i.ibb.co/FqVVPkR7/file-292.jpg')).split()  # Sample pic
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', ''-1002558348052).split()]
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/BruceJaat')
