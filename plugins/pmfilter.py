    ...
    if query.data.startswith("file"):
       ...
       #@codeflix_bots
        ...
        buttons = [[
                ...
                InlineKeyboardButton('⚙ ꜰᴇᴀᴛᴜʀᴇs', callback_data='main'),
...
#Deendayal403
        ...
        buttons = [[
            InlineKeyboardButton('• ɢʀᴏᴜᴘ •', url="https://t.me/+y9sugbgrEnM1NjRl"),
            InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs •', url="https://t.me/+XZmX_1FLbaBiMmE1")
       ],[ 
            InlineKeyboardButton('• ʙᴀᴄᴋ •', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('• ᴅᴇᴠᴇʟᴏᴘᴇʀ', user_id=int(7123837674)),
            InlineKeyboardButton('ɴᴇᴛᴡᴏʀᴋ •', url="https://t.me/berozgar_movie")
        ], [
            InlineKeyboardButton('• ʙᴀᴄᴋ •', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            InlineKeyboardButton('sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ 📜', url=''),
        ...
        if len(message.text) < 100:
            ...
            if not files:
                ...
                if settings["spell_check"]:
                    ai_sts = await m.edit('ᴘʟᴇᴀꜱᴇ ᴡᴀɪᴛ, ᴀʀᴛɪxᴀ ɪꜱ ᴄʜᴇᴄᴋɪɴɢ ʏᴏᴜʀ ꜱᴘᴇʟʟɪɴɢ...')
...
btn = [
    [
        InlineKeyboardButton(
            text=f"[{get_size(file.file_size)}] ...", callback_data=...
        ),
    ]
    for file in files
]
